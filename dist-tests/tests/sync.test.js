...
const src_1 = require("../packages/sync-engine/src");
function runSyncTests() {
    ...
    const writeResult = (0, src_1.applyTextOperation)(initialText, writeOp);
    ...
    const insertResult = (0, src_1.applyTextOperation)('const a = 1;', insertOp);
    ...
    const replaceResult = (0, src_1.applyTextOperation)('const foo = 123;', replaceOp);
    ...
    const noConflict = (0, src_1.checkVersionConflict)(validOp, 5, 'content');
    ...
    const conflict = (0, src_1.checkVersionConflict)(staleOp, 5, 'disk content v5');
    ...
    if (conflict) {
        const keepLaptopRes = (0, src_1.resolveConflict)(conflict, {
            conflict_id: conflict.conflict_id,
            choice: 'KEEP_LAPTOP',
        });
        assert(keepLaptopRes.finalContent === 'disk content v5', 'KEEP_LAPTOP preserves disk content');
        const keepPhoneRes = (0, src_1.resolveConflict)(conflict, {
            conflict_id: conflict.conflict_id,
            choice: 'KEEP_PHONE',
        });
        ...
        const manualRes = (0, src_1.resolveConflict)(conflict, {
            conflict_id: conflict.conflict_id,
            choice: 'MANUAL_MERGE',
    ...
    const tracker = new src_1.IdempotencyTracker();
